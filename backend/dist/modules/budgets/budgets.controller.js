...
let BudgetsController = class BudgetsController {
    ...
    getBudgetSummary(req, period) {
        if (!period) {
            throw new common_1.BadRequestException('El parámetro period es requerido (MM-YYYY)');
        }
        return this.budgetsService.getBudgetSummary(req.user.householdId, period);
    }
    upsertBudget(req, createBudgetDto) {
...
], BudgetsController.prototype, "getBudgetSummary", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:returntype", void 0)
], BudgetsController.prototype, "upsertBudget", null);

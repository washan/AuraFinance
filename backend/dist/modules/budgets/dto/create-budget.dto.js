...
], CreateBudgetDto.prototype, "itemId", void 0);
__decorate([
...
], CreateBudgetDto.prototype, "isBase", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.Matches)(/^(0[1-9]|1[0-2])-\d{4}$/, { message: 'period must be in MM-YYYY format' }),
    __metadata("design:type", String)
